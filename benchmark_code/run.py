...
def parse_arguments():
    ...
    # !!!
    parser.add_argument('--logger_name', type=str, default='mult',
                        help="Logger name for multimodal intent analysis.")

    parser.add_argument('--dataset', type=str, default='MINE',
                        help="The name of the used dataset.")

    parser.add_argument('--data_mode', type=str, default='goal',
                        help="The task mode (multi-class or binary-class).")

    # !!!
    parser.add_argument('--method', type=str, default='mult',
                        help="which method to use (text, mult, misa, mag_bert).")

    parser.add_argument("--text_backbone", type=str, default='bert-base-uncased',
    ...
    parser.add_argument('--gpu_id', type=str, default='2',
                        help="The used gpu index of your device.")

    parser.add_argument("--data_path", default='/data1/yq/004_intention/MIntRec/M3-datasets', type=str,
    ...
    parser.add_argument('--log_path', type=str,
                        default='logs', help="Logger directory.")

    parser.add_argument('--cache_path', type=str, default='cache',
                        help="The caching directory for pre-trained models.")

    parser.add_argument('--video_data_path', type=str,
                        default='video_data', help="The directory of the video data.")

    parser.add_argument('--audio_data_path', type=str,
                        default='audio_data', help="The directory of the audio data.")

    parser.add_argument('--video_feats_path', type=str,
                        default='video_feats.pkl', help="The directory of the video features.")

    parser.add_argument('--audio_feats_path', type=str,
                        default='audio_feats.pkl', help="The directory of the audio features.")
    ...
    parser.add_argument("--config_file_name", type=str,
                        default='mult_bert', help="The name of the config file.")

    # !!!
    parser.add_argument("--results_file_name", type=str, default='mult_bert.csv',
...
def run(args, debug_args=None):
    ...
    if args.save_results:
        ...
        logger.info('Results are saved in %s', str(
            os.path.join(args.results_path, args.results_file_name)))
...
def run_test(args, debug_args=None):
